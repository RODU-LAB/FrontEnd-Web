...
import PrevBtn from "public/images/prev_button.svg";
import NextBtn from "public/images/next_button.svg";
...
export default function DetailContent({ content }: { content: EduContent }) {
