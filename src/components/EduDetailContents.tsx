...
const EduDetailContents = () => {
  ...
  useEffect(() => {
    ...
    if (
      localStorage.getItem("checkLocation") === "1" ||
      localStorage.getItem("checkLocation") === "11"
    ) {
    ...
    return nested.a1.map(function (a) {
      return (
        <button className="EduDetail-content-container">
          <Link to={a.link}>
            <img
              src={require("../images/detailContents/" + a.img + ".png")}
              alt="img"
            />
  ...
  //       <button className="EduDetail-content-container">
  //         <Link to={a.link}>
  //           <img src={require('../images/detailContents/' + a.img + '.png')} alt="img"/>
  //           <p className="HashTag-text">{a.hash}</p>
  //           <p className="Title-text">{a.title}</p>
  //         </Link>
  //       </button>
  ...
  return (
    <>
      ...
      <div
        className="MainCategory-container"
        style={{ marginBottom: main2 || main3 || main4 ? "3.272rem" : "" }}
      >
        <button
