    ...
    const dummyData = [
        {
            ...
            textBold: "RODU가 보유한 교육 공간과 장비를 통한 실습 중심의 학습과 직접적인 강사와의 상호작용",
        ...
        },
        {
            ...
            title: "방문 교육",
            textNormalFirst: "RODU의 전문 강사가 직접 고객이나 기관의 위치로 방문하여 교육을 진행합니다. ",
        ...
        },
        {
            ...
            title: "RODU 챌린지",
            textNormalFirst: "특정 주제나 프로젝트에 대한 대회를 통해 참가자들이 경쟁하고 기술을 익힙니다. ",
            textBold: "창의적인 문제 해결, 팀워크를 기를 수 있으며 실무적인 경험과 경쟁을 통한 성장",
        ...
        },
        {
            ...
            textBold: "동영상 강의, 언터랙티브 콘텐츠, 온라인 퀴즈를 통해 자기주도적 학습",
        ...
        <MainContainer>
            ...
            <Box>
                ...
                {dummyData.map((data, idx) =>
                    <Container key={idx} onClick={()=>{DetailContentsRoutes(idx+1)}}>
